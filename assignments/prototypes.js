...
/*
  ...
  * Instances of Humanoid should have all of the same properties as CharacterStats and
  * GameObject.
...
// Test you work by un-commenting these 3 objects and the list of console logs below:
  ...
  // Stretch task: 
  // * Create Villain and Hero constructor functions that inherit from the Humanoid
  // constructor function.  
  // * Give the Hero and Villains different methods that could be used to remove
  // health points from objects which could result in destruction if health gets to 0 or
  // drops below 0;
